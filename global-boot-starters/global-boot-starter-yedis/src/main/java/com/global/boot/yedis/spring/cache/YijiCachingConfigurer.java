 ...
 */
public class YijiCachingConfigurer implements CachingConfigurer {
	private RedisTemplate redisTemplate;
	private long expiration;
	
	public YijiCachingConfigurer(RedisTemplate redisTemplate, long expiration) {
	...
	public CacheManager cacheManager() {
		return new YijiCacheManager(redisTemplate, expiration);
	}
	...
	public CacheErrorHandler errorHandler() {
		return new YijiCacheErrorHandler();
	}
}